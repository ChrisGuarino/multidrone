...
class DroneEnv(gym.Env):
    def __init__(self, render=False):
        ...
        #Set the path to the URDF we are using and establish gravity within the env. 
        ...
        obs_dim = 12 #state parameters[x, y, z, roll, pitch, yaw, v_x, v_y, v_z, ω_x, ω_y, ω_z]
        high = np.ones(obs_dim) * np.inf #Basically setting this env to be infinate in all dimensions
    ...
    #Reset the simulation for another episode. Returns obeservations from initial state
    ...
    #Called every timestep with an action
    def step(self, action):
        ...
        #Get observations, rewards gained, termination state, and etc from episode
        obs = self._get_obs()
